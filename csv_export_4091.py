...
def fetch_4091_query():
    try:
        with open(os.path.join(root(), "queries/4091.sql"), "r", encoding="utf-8") as file:
            query = file.read()
...
def parts_online():
    try:
        sql_path = os.path.join(root(), "queries/4091.sql")
