...
def fetch_4091p_query():
    try:
        with open(os.path.join(root(), "queries/4091p.sql"), "r", encoding="utf-8") as file:
            query = file.read()
