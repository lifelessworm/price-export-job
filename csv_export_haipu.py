...
def fetch_haipu_query():
    try:
        with open(os.path.join(root(), "queries/haipu.sql"), "r", encoding="utf-8") as file:
            query = file.read()
